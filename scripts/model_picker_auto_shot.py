...
def seed() -> ProviderController:
    ...
    # Pass the sandbox root directly: ProviderController's store-first readers
    # resolve provider settings beneath it, while the retired plaintext file
    # must never be opened or created by a capture (PR2a).
