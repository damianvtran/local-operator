...
class FakeHost:
    ...
    def capabilities(self) -> HostCapabilities:
        return HostCapabilities(self._methods, self._version)
...
def _flow(action: str, host: FakeHost, **kwargs: Any) -> builtin.ToolResult:
    ...
    return asyncio.run(flow(**kwargs, client=host))
