...
The first evidence scripts in this directory attach to a running runtime with
``RemoteSession.connect`` — the live-local case. Review round 1 (R5, Q5)
...
Usage:
    env -u NO_COLOR TERM=xterm-256color .venv/bin/python \\
        docs/evidence/viewer-capability-gap/cold_drive.py [out.svg]
"""
