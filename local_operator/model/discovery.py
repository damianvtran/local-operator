...
def fetch_models(
    ...
    *,
    ...
    Args:
        ...
        is_oauth: ``api_key`` is an OAuth access token, which changes the
            Anthropic auth scheme and selects ChatGPT's account-scoped catalogue
            for OpenAI logins.
        account_id: ChatGPT account/workspace id required by OpenAI's OAuth
            catalogue. Ignored by API-key and non-OpenAI transports.
