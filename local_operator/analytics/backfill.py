    ...
    *,
    ...
    try:
        ...
        if rebucket:
            ...
            # whole span, which the rebucket plan hands over in full (review
            # R11) — so ``derived == len(plan.days)`` means "every day the ledger
            # can answer, re-labelled". A short pass (a failure above) leaves the
