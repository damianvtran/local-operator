...
Stdlib-only and import-light: the registrant sits on the CLI startup path.
"""
...
from local_operator.mobile.types import HEARTBEAT_TIMEOUT_S, RUN_DIRNAME, SessionRecord
...
class RecordPublisher:
    """A registrant's side of the contract: publish on start, heartbeat on a
    timer, unpublish on exit. Held by the registrant; nothing here blocks."""
